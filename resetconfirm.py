...
# Form implementation generated from reading ui file 'pywiseresetconfirm.ui'
#
# Created: Thu Jan 04 10:01:37 2018
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "Reset Confirmation", None))
        self.label.setText(_translate("Dialog", "This will clear all data in all tables.\n"
"Are you sure?", None))
        self.buttonOK.setText(_translate("Dialog", "OK", None))
